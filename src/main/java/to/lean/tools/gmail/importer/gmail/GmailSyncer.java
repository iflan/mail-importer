...
/**
 * Main sync logic. After construction, instances must be initialized by calling
 * the {@link #init()} method. Messages are sync'd in batches by calling the
 * {@link #sync(List)} method.
 */
